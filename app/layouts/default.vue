...
<template>
  <UApp>
    <UHeader :toggle="{
      ...
      <template #title>
        <svg class="text-highlighted block w-auto h-6" width="800" height="200" viewBox="0 0 800 200" fill="none"
          xmlns="http://www.w3.org/2000/svg" data-state="open" style="webkit-touch-callout:none;pointer-events:auto;">
          <path
